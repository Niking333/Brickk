const enLang = {
    error: 'Es kam ein Fehler bei der Ausführung des Commands auf',
    commandDisabled: 'Dieser Command ist derzeit deaktiviert!',
    //avatar.js
    avatarDescription: "Zeigt deinen Avatar mit Download-Links",
    avatarUserOptionDescription: "Von welchem User soll das Avatar gezeigt werden?",
    avatarTitle: "{username}'s Avatar",
    downloadPng: "▶️ Download PNG",
    downloadJpeg: "▶️ Download JPEG",
    //channelinfo.js
    channelInfo: "Kanal Informationen",
    channelName: "Kanal Name",
    channelID: "Kanal Id",
    channelType: "Typ",
    channelCreatedAt: "Erstellt am",
    channelTopic: "Thema",
    channelNSFW: "NSFW",
    ...
    channelYes: "Ja",
    channelNo: "Nein",
    channelMentionValid: "Bitte gib einen Kanal an",
    channelInfoDescription: 'Zeigt Infos pber einen Kanal',
    channelOptionDescription: 'Von welchem Kanal sollen die Infos angezeigt werden',
    channelMentionValid: 'Bitte gib einen Kanal an',
    ...
    // servericon.js
    serverIconDescription: "Zeigt das Icon des Servers",
    serverIconTitle: "{guildName} Server Icon",
    serverIconNoIcon: "Dieser Server hat kein Icon",
    // serverinfo.js
    serverInfoDescription: "Zeigt die Informationen über den Server an",
    serverInfoTitle: "Server Informationen",
    serverInfoError: "Es ist ein fehler während dem ausführen des Commands aufgetreten. Versuche es später ernuet!",
    serverInfoFields: {
    ...
    serverId: "Server ID",
    members: "Mitglieder",
    membersNonBots: "Mitglieder (Non-Bots)",
    bots: "Bots",
    serverBoosts: "Server Boosts",
    categories: "Kategorien",
    totalChannels: "Kanaäle Insgesamt",
    textChannels: "Text Kanäle",
    voiceChannels: "Sprach Kanäle",
    stageChannels: "Stage Kanäle",
    emojis: "Emojis",
    normalEmojis: "Normal Emojis",
    animatedEmojis: "Animated Emojis",
    stickers: "Stickers",
    roles: "Rollen",
    serverCreatedOn: "Server erstellt am",
    emojisList: "Emojis Liste",
    rolesList: "Rollen Liste"
    },
